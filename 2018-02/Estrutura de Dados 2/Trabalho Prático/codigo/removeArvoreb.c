...
Arvore* remover_de_nao_folha (Arvore *a, int index)
{
    ...
    /*Quando nenhum dos filhos tem número de chaves maior que o mínimo (Caso 2C - Não implementado)*/
    else
    {
...
Arvore *remover (Arvore *a, TIPO k)
{
    ...
    else
    {
        ...
        /*Chama a função recursivamente até que chegue no nó que contém a chave, ou em uma folha, caso a árvore não
        possua a chave*/
